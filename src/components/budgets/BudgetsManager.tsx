              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex h-7 w-7 items-center justify-center rounded-lg text-text-muted hover:text-danger-400 hover:bg-danger-500/10 transition-colors cursor-pointer text-xs"
                ...
                {b.status === 'warning' && (
                  <div className="text-[11px] font-semibold text-warning-400">
                    ⚠️ Te quedan {formatCurrency(b.monthlyLimit - b.spent)} de este presupuesto
                  </div>
                )}
              </div>
            );
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
          <div className="relative w-full max-w-md rounded-3xl border border-brand-500/30 bg-surface-50 p-6 shadow-2xl space-y-5">
            <button
              ...
              className="absolute top-4 right-4 flex h-8 w-8 items-center justify-center rounded-xl bg-surface-100 border border-border-default text-text-muted hover:text-text-primary cursor-pointer"
            >
              ✕
            </button>

            <div className="text-center space-y-1">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-500/20 text-2xl">📊</div>
